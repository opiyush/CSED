...
if(isset($_SESSION["role"])){
  if($_SESSION["role"]=="Faculty")
  {
    ...
    <body>
      ...
      <div class="content1">
      <form action="Publication_Upload_Backend.php" method="post">
        <div class="form-group">
          <label for="New Arrival Details">Publication Details</label><br><br>
  ...
  <option value="Book Chapter Published">Book Chapter Published</option>
