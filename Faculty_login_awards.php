...
if(isset($_SESSION["role"])){
  if($_SESSION["role"]=="Faculty")
  {
    ...
    <body>
      ...
      <div class="content1">
        <form action="Faculty_Upload_Backend_3.php" method="post">
          <div class="form-group">
            <label for="Awards Honors and Achievements">Awards Honors and Achievements</label><br><br>
      ...
      <<?php
      $stmt = sqlsrv_query( $conn, "select * from Awards_Upload where Uploaded_By=?",array($email)); //making query and storing it in stmt variable
      ?>
