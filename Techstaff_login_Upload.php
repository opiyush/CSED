...
if(isset($_SESSION["role"])){
  if($_SESSION["role"]=="TechStaff")
  {
    ...
    <head>
      ...
      <title>Upload Lab Details</title>
    </head>
    <body>
      ...
      <<?php
      $stmt = sqlsrv_query( $conn, "select * from TechStaff_Upload where Uploaded_By=?",array($email)); //making query and storing it in stmt variable
       ?>
